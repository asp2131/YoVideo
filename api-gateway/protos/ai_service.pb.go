...
type TranscribeAudioRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// bytes audio_data = 1; // Raw audio bytes - Replaced by video_storage_path
	VideoStoragePath string `protobuf:"bytes,1,opt,name=video_storage_path,json=videoStoragePath,proto3" json:"video_storage_path,omitempty"` // e.g., "{project_id}/{video_uuid_with_extension}"
...
const file_protos_ai_service_proto_rawDesc = "" +
	...
	"\x05score\x18\x04 \x01(\x02R\x05score\"s\n" +
	"\x16TranscribeAudioRequest\x12,\n" +
	"\x12video_storage_path\x18\x01 \x01(\tR\x10videoStoragePath\x12+\n" +
